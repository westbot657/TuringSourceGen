...
//     private const string AttributeName = "WasmRsClass";
//     
...
// ";
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        var provider = context.SyntaxProvider
            ...
            .Where(t => t.isWasmClass)
            .Select((t, _) => t.Item1);
    }

    private static (ClassDeclarationSyntax, bool isWasmClass) GetClassDeclarationForSourceGen(
        GeneratorSyntaxContext context)
    {
        ...
        foreach (AttributeSyntax attributeSyntax in attributeListSyntax.Attributes)
        {
            ...
            if (attributeName == $"{Namespace}.WasmRsClass")
...
[StructLayoutKind(LayoutKind.Sequential)]
struct {className}C {{
    public int internalId; // this is the wasm ref lookup table key that points to the connected instance
